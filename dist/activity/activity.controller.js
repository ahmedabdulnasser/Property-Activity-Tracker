...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: "Filter activities", description: "Returns activities matching filter criteria (user name/email, type, time range)." }),
...
__decorate([
    ...
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: "Create activity", description: "Creates a new activity. Requires authentication." }),
    (0, swagger_1.ApiBody)({ schema: { example: { type: "visit", propertyId: 1, salesRepId: 2, timestamp: "2025-08-18T12:00:00Z" } } }),
