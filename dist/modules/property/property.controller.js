...
let PropertyController = class PropertyController {
    ...
    async deleteAll() {
        return this.propertyService.deleteAll();
    }
    async delete(id) {
        return this.propertyService.delete(id);
    }
    async seed() {
        return this.propertyService.seedFromCsv("./src/database/Data Sample.csv");
    }
...
__decorate([
    ...
    (0, swagger_1.ApiBody)({
        schema: {
            example: { address: "123 Main St", city: "Metropolis", price: 500000 },
        },
    }),
...
__decorate([
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], PropertyController.prototype, "deleteAll", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
...
__decorate([
    (0, common_1.Post)("seedfromcsv"),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], PropertyController.prototype, "seed", null);
__decorate([
